...
<h2 className='lead fs-1'>What is CarPool ?</h2>
...
<p className='mt-2 text-muted lead'>Hence, we have committed to providing a convenient, economical and sustainable solution to this problem through carpooling and bike pooling.</p>
</div>
